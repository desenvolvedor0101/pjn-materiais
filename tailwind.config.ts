  ...
  theme: {
    ...
    extend: {
      ...
      glass: {
        ...
        "brand-stone-beige": "hsl(var(--brand-stone-beige))",
      },
      backgroundImage: {
        "gradient-primary": "var(--gradient-primary)",
        "gradient-overlay": "var(--gradient-overlay)",
        "gradient-card": "var(--gradient-card)",
        /* (adicione também 'gradient-subtle' e 'gradient-hero' se precisar) */
      },
      boxShadow: {
        soft: "var(--shadow-soft)",
        medium: "var(--shadow-medium)",
        glow: "var(--shadow-glow)",
        /* (adicione strong, hero, etc. conforme original) */
      },
